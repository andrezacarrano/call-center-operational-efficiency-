...
- Link do Dashboard no Tableau: (https://public.tableau.com/views/AnlisedeIneficinciaOperacionaldoCallCenter/Dashboard1?:language=pt-BR&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
